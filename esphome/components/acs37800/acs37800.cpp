...
void ACS37800Component::dump_config() {
  ...
  LOG_SENSOR("  ", " Sense resistor for voltage measurement in Ohms: ", shunt_resistance_ohm_);
  LOG_SENSOR("  ", "Divider resistance for voltage measurement in Ohms: ", divider_resistance_ohm_);
  LOG_SENSOR("  ", "Number of samples for RMS calculations: ", number_of_samples_);
